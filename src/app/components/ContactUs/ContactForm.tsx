        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <p className="text-[10px] text-[#545454] font-normal leading-[1.8] roboto-font">
              By providing my phone number to Server Blink LLC, I agree and
              acknowledge that Server Blink may send text messages to my
              wireless phone number for any purpose. Message frequency will
              vary, and Message and data rates may apply. If you need further
              assistance, please reply “HELP”. You can also opt out by replying
              “STOP.” For more information on how your data will be handled,
              please visit&nbsp;
              <Link
                href="/privacy-Policy"
