      ...
      <div className="w-full xl:max-w-[1290px] 2xl:max-w-[1720px]">
        ...
        <div className="flex flex-wrap lg:flex-nowrap gap-10">
          ...
          {blogs.map((blog) => (
            ...
            >
              <div className="relative w-full h-72 xl:h-[23.4rem] xl:w-full 2xl:h-[31.3rem] 2xl:w-full rounded-md overflow-hidden">
                <Image
                  src={blog.image}
                  alt={blog.title}
                  fill
          ...
          <div className="product-right w-full lg:w-[25%] xl:w-[24%] 2xl:w-[24.1%]">
            ...
            <div className="border border-gray-300 rounded-[20px] h-max w-full">
              ...
              <div className="flex justify-center my-2">
                <Image
                  src={supportIcon1}
                  alt="Support 1"
                  className="2xl:w-20 2xl:h-20 xl:w-16 xl:h-16 w-16 h-16 rounded-full"
                  fetchPriority="high"
                />
                <Image
                  src={supportIcon2}
                  alt="Support 2"
                  className="2xl:w-20 2xl:h-20 xl:w-16 xl:h-16 w-16 h-16 rounded-full -ml-2"
                  fetchPriority="high"
                />
                <Image
                  src={supportIcon3}
            ...
            <div className="mt-6 border border-gray-300 rounded-[20px] h-max lg:h-max">
              ...
              <div className="px-6 py-6 flex flex-col items-center xl:items-center">
                <p className="h5-regular mb-4 max-w-[500px] leading-normal">
            ...
            <div className="space-y-5 my-5">
              ...
              <div className="flex items-center gap-4">
                <Image
                  ...
                  width={25}
                  height={24}
                  className="2xl:w-8 2xl:h-8 xl:w-8 xl:h-8 w-8 h-8 object-contain "
                />
