                      ...
                      if (e.key === "Enter") {
                        ...
                        if (q) {
                          ...
                          window.dispatchEvent(
                            new Event("searchFiltersUpdated"),
                          );
                          if (pathname === "/advanced-search") {
                ...
                {auth?.isAuthenticated ? (
                  ...
                  <>
                    <Link href="/auth/login">
                      <button className="font-bold text-[12px] sm:text-[14px] hover:text-gray-300 transition roboto-condensed-font">
                        Login
                      </button>
                    </Link>
                    <span className="font-bold roboto-font">or</span>
                      ...
                      {cart.length === 0 ? (
                        ...
                        <div className="relative">
                          ...
                          <div className="flex gap-2 p-4 pt-6">
                            <button
                              className="flex-1 font-(--font-roboto-condensed) font-bold bg-[#d42020] hover:bg-[#b81818] text-white text-[1rem] py-2.5 px-4 border-0 border-b-[3px] border-b-[#860109] transition uppercase tracking-wide"
