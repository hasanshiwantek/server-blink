...
const LinkHeader = () => {
  ...
  return (
    <header className="bg-[#393939] text-white w-full xl:max-w-[1170px] 2xl:max-w-[1170px] mx-auto border-b-3 border-[#8b8b8b] md:block hidden" style={{ fontFamily: "Roboto Condensed, Arial, Helvetica, sans-serif" }}>
