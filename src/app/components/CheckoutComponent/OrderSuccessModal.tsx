  ...
  if (!localOrders || localOrders.length === 0) {
    return (
      <div className="p-8 text-center">
        ...
        <Link href="/cart">
          <button className="mt-4 bg-[#d42020] hover:bg-[#d42020] text-white font-semibold py-2 px-6 rounded-full">
            Go to Shop
          </button>
        </Link>
      </div>
            ...
            <div className="space-y-8" >
              ...
              {index === 0 && (
                ...
                <button
                  ...
                  className="bg-[#d42020] hover:bg-[#d42020] text-white font-semibold py-3 px-8 rounded-full transition-colors"
                >
                  Check Your Orders
                </button>
              )}
              ...
              <div className="space-y-4 border-t border-gray-200 pt-6">
                {orderData.items.map((item: any) => (
                  <div key={item.id} className="flex gap-4">
                    <div className="w-20 h-20 bg-linear-to-br from-pink-200 to-purple-300 rounded-lg flex items-center justify-center text-3xl shrink-0">
