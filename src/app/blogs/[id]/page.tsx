...
const SITE_NAME = "Server Blink LLC";
const BASE_URL = "https://staging.sparemicro.com";
...
export async function generateMetadata({
  ...
  return {
    ...
    keywords:
      blog.tags ||
      `${blog.title}, ${blog.author}, auto parts, car spare parts, blog, ${SITE_NAME}`,
    authors: [
      {
        name: blog.author,
        url:
          blog.authorUrl ||
          `${BASE_URL}/author/${encodeURIComponent(blog.author)}`,
      },
    ],
    creator: blog.author,
    publisher: SITE_NAME,
